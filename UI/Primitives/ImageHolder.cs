...
namespace TeamJRPG
{
    public class ImageHolder : UIComposite
    {
        ...
        public ImageHolder(Texture2D texture, Vector2 startPosition, Color color, Vector2 scale, Stroke stroke)
        {
            ...
            hintBox = new System.Drawing.RectangleF(position.X, position.Y, image.texture.Width * scale.X, image.texture.Height * scale.Y);
