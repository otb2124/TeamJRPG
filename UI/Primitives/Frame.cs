...
namespace TeamJRPG
{
    public class Frame : UIComposite
    {
        ...
        public Frame(Vector2 startPosition, Vector2 size)
        {
            ...
            Texture2D backgroundTexture = Globals.assetSetter.textures[Globals.assetSetter.UI][1][3];
            Texture2D cornerTexture = Globals.assetSetter.textures[Globals.assetSetter.UI][1][0];
            ...
            //Horizontal
            float borderWidthScale = frameScale.X / generalScale * ((textSize.X + padding.X) / HborderTexture.Width) * 2;
            ...
            //Vertical
            float borderHeightScale = frameScale.Y / generalScale * ((textSize.Y + padding.Y) / VborderTexture.Height) * 2;
