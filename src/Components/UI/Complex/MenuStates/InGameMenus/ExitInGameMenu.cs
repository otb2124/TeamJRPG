...
namespace TeamJRPG
{
    public class ExitInGameMenu : UIComposite
    {
        public ExitInGameMenu()
        {
            ...
            //buttons
            TextButton noTextButton = new TextButton("No", new Vector2(framePos.X, framePos.Y + frameSize.Y - 32), 1, 11, Color.White);
            TextButton yesTextButton = new TextButton("Yes", new Vector2(framePos.X + frameSize.X - 48, framePos.Y + frameSize.Y - 32), 1, 12, Color.White);
