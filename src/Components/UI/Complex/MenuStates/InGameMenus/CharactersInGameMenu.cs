...
namespace TeamJRPG
{
    public class CharactersInGameMenu : UIComposite
    {
        ...
        public void RefreshPage()
        {
            ...
            Button leftArrow = new Button(buttonTexture, new Vector2(Globals.camera.viewport.Width / 2 + characterName.components[0].position.X - buttonTexture.srcRect.Width - buttonOffset.X, framePos.Y + textSize.Y / 2 - buttonTexture.srcRect.Height / 3), Vector2.One, 9, new List<string> { "Previous" });
            ...
            Button rightArrow = new Button(buttonTexture, new Vector2(Globals.camera.viewport.Width / 2 + characterName.components[0].position.X + textSize.X + buttonOffset.X, framePos.Y + textSize.Y / 2 - buttonTexture.srcRect.Height / 3), Vector2.One, 10, new List<string> { "Next" });
