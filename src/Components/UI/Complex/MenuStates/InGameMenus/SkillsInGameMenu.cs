...
namespace TeamJRPG
{
    public class SkilsInGameMenu : UIComposite
    {
        ...
        public SkilsInGameMenu()
        {
            ...
            Button leftArrow = new Button(buttonTexture, new Vector2(framePos.X + frameSize.X/2 + currentCharacter.position.X - buttonTexture.srcRect.Width - buttonOffset.X, framePos.Y + currentCharacter.charSprite.srcRect.Height / 2 - buttonTexture.srcRect.Height / 3), 1, 13, "Previous");
            ...
            Button rightArrow = new Button(buttonTexture, new Vector2(framePos.X + frameSize.X / 2 + currentCharacter.position.X + currentCharacter.charSprite.srcRect.Width + buttonOffset.X, framePos.Y + currentCharacter.charSprite.srcRect.Height / 2 - buttonTexture.srcRect.Height / 3), 1, 14, "Next");
