...
namespace TeamJRPG
{
    public class InventoryInGameMenu : UIComposite
    {
        ...
        public InventoryInGameMenu()
        {
            ...
            Button weaponCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(0*32, 32*4), new Vector2(32, 32)), framePos3 + catMargin, 2, 30, new List<string> { "Weapons" });
            Button armorCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(1 * 32, 32 * 4), new Vector2(32, 32)), new Vector2(framePos3.X + catMargin.X + catItemSize.X + catPadding.X, framePos3.Y + catMargin.Y), 2, 31, new List<string> { "Armor" });
            Button potionCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(2 * 32, 32 * 4), new Vector2(32, 32)), new Vector2(framePos3.X + catMargin.X + (catItemSize.X + catPadding.X) * 2, framePos3.Y + catMargin.Y), 2, 32, new List<string> { "Consumables" });
            Button materialCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(3 * 32, 32 * 4), new Vector2(32, 32)), new Vector2(framePos3.X + catMargin.X + (catItemSize.X + catPadding.X) * 3, framePos3.Y + catMargin.Y), 2, 33, new List<string> { "Materials" });
            Button valueableCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(4 * 32, 32 * 4), new Vector2(32, 32)), new Vector2(framePos3.X + catMargin.X + (catItemSize.X + catPadding.X) * 4, framePos3.Y + catMargin.Y), 2, 34, new List<string> { "Valuables" });
            Button questItemCategory = new Button(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.ui, 0, new Vector2(5 * 32, 32 * 4), new Vector2(32, 32)), new Vector2(framePos3.X + catMargin.X + (catItemSize.X + catPadding.X) * 5, framePos3.Y + catMargin.Y), 2, 35, new List<string> { "Quest Items" });
