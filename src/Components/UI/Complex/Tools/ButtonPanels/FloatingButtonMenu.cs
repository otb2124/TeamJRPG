                ...
                if (buttons[i].buttonBox.Contains(new System.Drawing.PointF(Globals.inputManager.GetCursorPos().X, Globals.inputManager.GetCursorPos().Y)))
                {
                    ...
                    if (Globals.inputManager.IsMouseButtonClick(InputManager.MouseButton.Left))
                    {
                        ...
                        switch (buttons[i].id)
                        {
                            ...
                            case 40: //uneqip
                                Globals.inventoryHandler.UneqipItem(item);
                                break;
                            case 41: //equip
                                Globals.inventoryHandler.EquipItem(item);
                                break;
                            case 42: //description
                                Globals.inventoryHandler.DescribeItem(item);
                                break;
                            case 43: //drop
                                Globals.inventoryHandler.DropItem(item);
                                break;
                            case 44: //destroy
                                Globals.inventoryHandler.DestroyItem(item);
                                break;
                            case 45: //consume
                                Globals.inventoryHandler.ConsumeItem(item);
                                break;
                        }
                    }
                }
