...
namespace TeamJRPG
{
    public class TextButton : Button
    {
        ...
        public TextButton(string text, Vector2 startPosition, int fontId, int buttonID, Color color, int type = 0) : base(Globals.TextureManager.GetSprite(TextureManager.SheetCategory.placeholders, 0, new Vector2(0, 0), new Vector2(32, 32)), startPosition, 1, buttonID, null)
        {
            this.type = type;
