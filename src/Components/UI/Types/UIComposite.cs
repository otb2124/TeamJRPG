...
namespace TeamJRPG
{
    public class UIComposite
    {
        ...
        public enum UICompositeType { MOUSE_CURSOR, TEXT_FRAME, SCROLLPANE, ITEM_HOLDER, FLOATING_INFO_BOX, BUTTON, GROUP_BARS, DESCRIPTION_WINDOW, CURRENT_CHARACTER_POINTER,
            ...
            DIALOGUE_TEXT_BOX,
            BATTLE_TURN_BAR, BATTLE_MENU, BATTLE_SKILL_MENU, BATTLE_CONSUMABLE_MENU, BATTLE_INTERRACTION_MENU, BATTLE_TARGET_MENU,
        };
